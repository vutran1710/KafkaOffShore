export default [
  ...
  },
  {
    ...
    image: "http://lorempixel.com/400/200/technics/3/",
    tags: ['long', 'tech', 'software'],
  },
  {
    id: 4,
    content: "I wanted you to see what real courage is, instead of getting the idea that courage is a man with a gun in his hand. It’s when you know you’re licked before you begin but you begin anyway and you see it through no matter what.",
    image: "http://lorempixel.com/400/200/nightlife/4/",
    tags: ['short', 'urban', 'dynamic'],
  },
  {
    id: 5,
    content: "We believe that we can change the things around us in accordance with our desires—we believe it because otherwise we can see no favourable outcome. We do not think of the outcome which generally comes to pass and is also favourable: we do not succeed in changing things in accordance with our desires, but gradually our desires change. The situation that we hoped to change because it was intolerable becomes unimportant to us. We have failed to surmount the obstacle, as we were absolutely determined to do, but life has taken us round it, led us beyond it, and then if we turn round to gaze into the distance of the past, we can barely see it, so imperceptible has it become.",
    image: "http://lorempixel.com/400/200/business/5/",
    tags: ['long', 'work', 'urban', 'office'],
  },
  {
    id: 6,
    content: "In the mirrors of the many judgments, my hands are the color of blood. I sometimes fancy myself an evil which exists to oppose other evils; and on that great Day of which the prophets speak but in which they do not truly believe, on the day the world is utterly cleansed of evil, then I too will go down into darkness, swallowing curses. Until then, I will not wash my hands nor let them hang useless.",
    image: "http://lorempixel.com/400/200/animals/6/",
    tags: ['short', 'work', 'urban', 'office'],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    image: "http://lorempixel.com/400/200/cats/8/",
    tags: ['short', 'animals', 'pet', 'cute'],
  },
  {
    id: 9,
    ...
    tags: ['long', 'tech', 'engineering', 'academic'],
  },
  {
    id: 10,
    ...
    image: "http://lorempixel.com/400/200/city/10/",
    tags: ['long', 'urban', 'academic'],
  }
]
